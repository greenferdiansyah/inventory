            ...
            <div class="card card-outline-success">
                ...
                <div class="card-body">
                    <form id="form-vendor" name="form-vendor" method="POST" class="p-20">
                        ...
                        <input type="hidden" name="id_vendor" id="id_vendor" value="{id_vendor}" style="display: none"> 
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input  class="form-control error" type="text" value="{kode_vendor}" id="kode_vendor" name="kode_vendor"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="Kode vendor Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input  class="form-control error" type="text" value="{nama_vendor}" id="nama_vendor" name="nama_vendor"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="Nama vendor Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input  class="form-control error" type="text" value="{alamat}" id="alamat" name="alamat"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="alamat vendor Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input  class="form-control error" type="text" value="{telpon}" id="telpon" name="telpon"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="telpon vendor Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input  class="form-control error" type="text" value="{email}" id="email" name="email"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="email vendor Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
		...
		submit: {
			...
			callback: {
				...
				onSubmit: function(node) {
					ajaxFormSubmit("form-vendor", "/form_submit");
				},
