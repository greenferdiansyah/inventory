    ...
    <div class="row">
       <div class="col-lg-12">
            <div class="card card-outline-success">
                ...
                <div class="card-body">
                    <form id="form-jenis" name="form-jenis" method="POST" class="p-20">
                        <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none"> 
                        <input type="hidden" name="action" value="{action}" style="display: none"> 
                        <input type="hidden" name="id_jenis" id="id_jenis" value="{id_jenis}" style="display: none"> 
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       <label class="control-label"><small>Nama Jenis</small></label>
                                       <input  class="form-control error" type="text" value="{nama_jenis}" id="nama_jenis" name="nama_jenis"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="Nama Jenis Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
		...
		submit: {
			...
			callback: {
				...
				onSubmit: function(node) {
					ajaxFormSubmit("form-jenis", "/form_submit");
				},
