    ...
    <div class="row">
       <div class="col-lg-12">
            <div class="card card-outline-success">
                ...
                <div class="card-body">
                    <form id="form-cabang" name="form-cabang" method="POST" class="p-20">
                        <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none"> 
                        <input type="hidden" name="action" value="{action}" style="display: none"> 
                        <input type="hidden" name="id_cabang" value="{id_cabang}" style="display: none"> 
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input  class="form-control error" type="text" value="{nama_cabang}" id="nama_cabang" name="nama_cabang"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="Nama Cabang Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input  class="form-control error" type="text" value="{kode_cabang}" id="nama_kode_cabang" name="kode_cabang"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="Kode Cabang Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
		...
		submit: {
			...
			callback: {
				...
				onSubmit: function(node) {
					ajaxFormSubmit("form-cabang", "/form_submit");
				},
