...
class Satuan extends CI_Controller {
	...
	function __construct() {
		...
		$this->access 		= $this->page_render->page_auth_check('satuan');
	...
	public function json_list(){
			...
			$data 			= $this->m_satuan->list_data($length,$start,$search,$order,$dir);
	...
	public function form(){
        ...
        if($action != 'Edit'){
				...
				$result			        = $this->m_satuan->detail_data($id);
                $title					= 'Edit Satuan';
	...
	public function form_submit(){
		...
		$response	= $this->m_satuan->submit($action, $data);
	...
	public function delete(){
		$id_satuan 		    = $this->input->post("id_satuan");
		$response	        = $this->m_satuan->delete($id_satuan);
		echo json_encode(array("status"=> $response["status"], "title"=>$response["title"], "reason"=> $response["reason"]));
	}
}
