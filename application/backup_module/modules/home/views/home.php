            ...
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover earning-box">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width:50px;"><span class="round"><img src="{base_url}assets/images/users/8.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-success"><img src="{base_url}assets/images/users/1.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-primary"><img src="{base_url}assets/images/users/4.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-warning"><img src="{base_url}assets/images/users/5.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-danger"><img src="{base_url}assets/images/users/1.jpg" alt="user" width="50"></span></td>
                                                <td>
                                ...
                                <div class="chat-box">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <li class="reverse">
                                            ...
                                            <div class="chat-img"><img src="{base_url}assets/images/users/5.jpg" alt="user" /></div>
                                            <div class="chat-time">10:57 am</div>
                                        </li>
                                        <!--chat Row -->
                                        <li class="reverse">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="profiletimeline m-t-40">
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="{base_url}assets/images/users/4.jpg" alt="user" class="img-circle"> </div>
                                        <div class="sl-right">
                                            <div><a href="#" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                    ...
                    <div class="col-lg-4 col-xlg-3">
                        ...
                        <!-- Column -->
                        <div class="card">
                            <div class="card-body bg-inverse" style="background: url({base_url}assets/images/background/user-info.jpg) / cover;">
