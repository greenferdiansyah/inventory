    ...
    <div class="row">
       <div class="col-lg-12">
            <div class="card card-outline-success">
                ...
                <div class="card-body">
                    <form id="form-merk" name="form-merk" method="POST" class="p-20">
                        <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none"> 
                        <input type="hidden" name="action" value="{action}" style="display: none"> 
                        <input type="hidden" name="id_merk" value="{id_merk}" style="display: none"> 
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       <label class="control-label"><small>Nama Merk</small></label>
                                       <input  class="form-control error" type="text" value="{nama_merk}" id="nama_merk" name="nama_merk"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="Nama Merk Tidak Boleh Kosong !">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
		...
		submit: {
			...
			callback: {
				...
				onSubmit: function(node) {
					ajaxFormSubmit("form-merk", "/form_submit");
				},
