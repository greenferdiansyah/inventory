            ...
            <div class="card card-outline-success">
                ...
                <div class="card-body">
                    <form id="form-tenant" name="form-tenant" method="POST" class="p-20">
                        ...
                        <input type="hidden" name="tenant_id" value="{tenant_id}" style="display: none"> 
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                       <label class="control-label"><small>Code Alias</small></label>
                                       <input  class="form-control error" type="text" value="{tenant_alias}" id="tenant_alias" name="tenant_alias"  
                                                data-validation="[NOTEMPTY]"
                                                data-validation-message="Tenant Alias are required">
                                    </div>
                                </div>
                            </div>
